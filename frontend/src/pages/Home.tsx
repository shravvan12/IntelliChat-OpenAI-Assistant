...
const Home = () => {
  ...
  <Box width={'100%'} height={'100%'} display={'flex'} mx={'auto'}>
    <Box sx={{display:'flex',width:'100%', flexDirection:"column",
      alignItems:'center',mx:'auto',mt:'3'
    }}>
      <Box>
      ...
      <Box sx={{display:'flex',width:'100%',mx:'auto'}}>
        <img src='chat.png' alt='chatbot' style={{display:'flex',margin:'auto',width:'60%',borderRadius:20,
          boxShadow:'-5px -5px 105px #64f3d5',marginTop:20,marginBottom:20
        }}/>
      </Box>
        <Footer/>
    </Box>
